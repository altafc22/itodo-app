...
import 'board_view_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Widget listWidget = ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        if (widget.lists![index].boardViewState == null) {
          widget.lists![index] = BoardList(
            items: widget.lists![index].items,
            headerDecoration: widget.lists![index].headerDecoration,
            footer: widget.lists![index].footer,
            header: widget.lists![index].header,
            listDecoration: widget.lists![index].listDecoration,
            boardViewState: this,
...
//                }
    ...
    return Container(
        ...
        child: Listener(
            ...
            onPointerUp: (opu) {
              if (onDropItem != null) {
                final tempDraggedItemIndex = draggedItemIndex;
                final tempDraggedListIndex = draggedListIndex;
                final startDraggedItemIndex = startItemIndex;
                final startDraggedListIndex = startListIndex;
